...
import { Shield, AlertTriangle, ChevronDown, ChevronRight, Download, RefreshCw } from "react-feather"
    ...
    <div className="scan-results">
      ...
      {result.status === "completed" && (
        <>
          ...
          {result.domain_info && (
            <div className="card" style={{ marginBottom: "20px" }}>
              <div className="card-header" style={{ cursor: "pointer" }} onClick={() => toggleSection("domain_info")}>
                  ...
                  <table className="table">
                    <tbody>
                      ...
                      {result.domain_info.waf_cdn && (
                        <tr>
                          <td>
                            <strong>WAF/CDN</strong>
                          </td>
                          <td>
                            {result.domain_info.waf_cdn.detected ? (
                              <div>Detected: {result.domain_info.waf_cdn.providers.join(", ")}</div>
                            ) : (
          ...
          {result.subdomains && (
            <div className="card" style={{ marginBottom: "20px" }}>
              <div className="card-header" style={{ cursor: "pointer" }} onClick={() => toggleSection("subdomains")}>
              ...
              {expandedSections.subdomains && result.subdomains.items.length === 0 && (
                <div style={{ padding: "15px", textAlign: "center" }}>No subdomains discovered</div>
              )}
            </div>
          )}
          ...
          {result.vulnerabilities && (
            <div className="card" style={{ marginBottom: "20px" }}>
              ...
              {expandedSections.vulnerabilities && result.vulnerabilities.items.length === 0 && (
                <div style={{ padding: "15px", textAlign: "center" }}>No vulnerabilities detected</div>
              )}
            </div>
          )}
          ...
          {result.recommendations && (
            <div className="card" style={{ marginBottom: "20px" }}>
              ...
              {expandedSections.recommendations && result.recommendations.length === 0 && (
                <div style={{ padding: "15px", textAlign: "center" }}>No recommendations available</div>
              )}
            </div>
          )}
          ...
          {/* Raw JSON */}
          <div className="card">
            <div className="card-header" style={{ cursor: "pointer" }} onClick={() => toggleSection("raw_json")}>
